...
Runs an honest Rust substrate demo:
  - first-60-second visible wins: daemon ready time, dependency transport/store/checksum smoke, artifact/POM read-through, real-build remote requests avoided, file-watch latency
