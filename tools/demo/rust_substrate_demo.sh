...
What this proves:
  ...
  - Native archive coverage includes Zip, Tar, War, and Ear tasks with reproducible ZIP timestamps, duplicate-entry strategy handling, empty-directory semantics, file permissions, and bzip2 TAR output.
