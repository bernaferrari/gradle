...
// zr2e/8lk7 next (symlink/mkdir richer lowering + VFS cross, scheduler 019e6b6437ee recurring) per "How to Work on a Slice" AGENTS.md read FULL FIRST at /Users/bernardoferrari/Downloads/gradle-refactor/gradle-fork/substrate/AGENTS.md + full directive x2x2 from 8lk7 sustain + "more sub-agents = more task_executor richer lowering (symlink/mkdir) + VFS cross + entire port accelerated" + "more sub-agents turned VFS failure 019e6885-51c7 into more cross surface" + "Go parallel forever. Entire port accelerated." + "use more sub-agents to do more work and migrate more to rust" + multi-year. Abs paths: this + mkdir_op.rs + fp:1229 + watch:766 + 2 Java (after 8lk7 blocks) + plan (Fresh after prior 019e6b4f2b8b anchor) + PARITY + MIGRATION + .beads (8lk7 + 8lk7.1) + AGENTS + scheduler 019e6b6437ee + fleet + cargo fuel. Safe terminal (1 non-hard here). 0 reg 20+. Java FIRST + differential + pilot + gov + spawn + bd children. "How to Work on a Slice". Follow exactly. Entire port accelerated.
