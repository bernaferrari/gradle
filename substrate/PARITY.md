...
- The first-60-seconds demo has a fast mode for user-visible wins and a proof
  ...
  Java-library corpus project with Gradle configuration-cache reuse and zero
  JVM task forwards, real-build dependency read-through with static
  direct/transitive prefetch, and native file-watch latency. Proof mode keeps
  static Maven artifact prefetch, artifact read-through, metadata read-through,
  and uncached resource download seam checks available without slowing the
  visible path.
...
- `python3 tools/demo/first_60_seconds.py --mode fast --skip-build --output build/first60-fast.json` passed with daemon socket ready=666.0ms (daemon self-report 9ms), authoritative Rust DAG=21907.5ms with cold 18856.6ms/11 Rust tasks, warm 3046.7ms/11 Rust tasks, Gradle configuration-cache reuse on the warm run, 0 JVM forwards, real-build dependency read-through=7632.7ms with remote requests avoided=7/7 and deterministic dynamic/direct-static/transitive-static output SHA-256 values `742d753d434f2e408762a9cbcc75621c441e0ed5dea5961d65b05ff3013575fc` / `88f9a4aa9c2579d0caa524dac61d45a114f381572629c6645fa28979d2501196` / `ecffccc8258a7d1647e4f911a8b9c6874d86f3ef8a88ddf0faad23d3e1cd148b`, and file-watch first event=11ms.
