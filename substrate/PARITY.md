...
`excludeGroup`, `includeGroupAndSubgroups`, and `excludeGroupAndSubgroups`
content filters are captured as native repository group filters and Rust skips
repositories that do not admit a dependency group. Other content filters are
still marked unsupported, including module/version, regex, configuration, and
required-attribute gates. Custom repository
